...
@Controller
public class MainExhibitions {

	@Autowired
	private ExhibitionService exhibitionService;
	
	private static final Logger logger = LoggerFactory.getLogger(MainExhibitions.class);
	
	@RequestMapping(value="/mainExhibitions", method=RequestMethod.GET)
	public void main(Model model) {
		logger.info("/mainExhibitions [GET]");
