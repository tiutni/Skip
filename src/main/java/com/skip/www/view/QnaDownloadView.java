...
public class QnaDownloadView extends AbstractView{
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		//모델값 가져오기
		QnAFile file = (QnAFile) model.get("qnaFile");
		
		//업로드된 파일의 객체
		
		File src = new File(context.getRealPath("upload"), file.getQnaFileStoredName());
		...
		String outputName = URLEncoder.encode(file.getQnaFileOriginName(), "UTF-8");
