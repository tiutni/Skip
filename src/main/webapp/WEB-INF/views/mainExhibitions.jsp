	...
	<div class="container">
		...
		<div class="flex-w flex-sb-m p-b-52" style="margin: 9px 0px 10px 0px">
			...
			<div class="flex-w flex-l-m filter-tope-group m-tb-10">
				<button class="stext-106 cl6 hov1 bor3 m-r-32 m-tb-5" onclick="location.href='/mainConcerts'">
					Concerts
				</button>

				<button class="stext-106 cl6 hov1 bor3 m-r-32 m-tb-5" onclick="location.href='/mainExhibitions'">
					Exhibitions
				</button>
			</div> <!-- 카테고리 End -->
		</div>
