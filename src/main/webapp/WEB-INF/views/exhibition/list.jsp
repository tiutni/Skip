...
<form action="/exhibition/list" method="get" style="text-align: center;">
...
<div class="body">
<br>
<h3 style="margin-left: 30px;">현재 가장 인기있는 TOP3 전시회</h3>
	...
	<div style="width: 300px; height: 245px; display: inline-block; margin: 30px; text-align: center;">
		<div style="width: 300px; height: 210px;">
			<a href="/exhibition/view?exNo=${i.exNo }">
				<img src="/upload/${i.exImgStoredName }" style="height: 210px; width:200px;">
			</a>
		</div>
		<br>
		<a href="/exhibition/view?exNo=${i.exNo }"><span><b>${i.exTitle }</b></span></a><br>
